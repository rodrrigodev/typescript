...
const numbers: number[] = [12, 5, 54, 6]
// console.log(Math.max(...numbers))

const classroomOne: string[] = ['Tiago', 'Bruno', 'Michael']
const classroomTwo: string[] = ['Amanda', 'Rose', 'Bia']
...
const array: [number, string, Boolean] = [15, 'Hello', true]
...
const userS: string = "Rodrigo"
const notifications: string = '18'
